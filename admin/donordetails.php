                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                            <input type="radio" value="male" name="sex" <?php if(isset($res['Gender']) && $res['Gender']== "male"){echo "checked";}?> readonly>Male                         
                            </div>
                            <div class="col-sm-4">
                            <input type="radio" value="female" name="sex" <?php if(isset($res['Gender']) && $res['Gender']== "female"){echo "checked";}?> readonly>Female   
                            </div>                       
                        </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="b_type" class="form-control" >
                                    <option value="<?php if(isset($res['Bloodgroup'])){echo $res['Bloodgroup'];}?>" readonly>Your Bloodgroup: <?php if(isset($res['Bloodgroup'])){echo $res['Bloodgroup'];}?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="hbsag" class="form-control">
                                    <option value="<?php if(isset($res['Hbsag'])){echo $res['Hbsag'];}?>" readonly>HBsAg :<?php if(isset($res['Hbsag'])){echo $res['Hbsag'];}?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="aids" class="form-control">
                                    <option value="<?php if(isset($res['Aids'])){echo $res['Aids'];}?>" readonly>Aids :<?php if(isset($res['Aids'])){echo $res['Aids'];}?></option>
                                    <option value="NEGATIVE">NEGATIVE</option>
                                    <option value="POSITIVE">POSITIVE</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                  <select name="malariaSmear" class="form-control">
                                    <option value="<?php if(isset($res['MalariaSmear'])){echo $res['MalariaSmear'];}?>" readonly>Malaria Smear :<?php if(isset($res['MalariaSmear'])){echo $res['MalariaSmear'];}?></option>
                                    <option value="NEGATIVE">NEGATIVE</option>
                                    <option value="POSITIVE">POSITIVE</option>
                                </select>
                            </div>
